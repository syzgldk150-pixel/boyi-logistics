...
class SessionBroker:
    ...
    def _start_status_alert(self, payload: dict[str, Any]) -> None:
        ...
        def runner() -> None:
            try:
                ...
                send_tms_session_disconnected_alert(alert_payload)
            except Exception:
    ...
    def _dependency_error(self, message: str) -> TMSAuthStateError:
        return TMSAuthStateError(
            ...
            (
                f"{message} "
                "请在 /home/deng/projects/agent 执行 "
    ...
    def _send_code_yunda(self) -> dict[str, Any]:
        with self._lock:
            self._close_pending_locked()
            config = self.resolve_login_config()
    ...
    def _submit_code_yunda(self, code: str) -> dict[str, Any]:
