...
class AutomationProjectPolicyService:
    ...
    def _supersede_safely_suspended_runs(
        self,
        uow: Any,
        *,
        automation_id: str,
        ...
        for previous_run, previous_item in safe_rows:
            ...
            self._append_automation_supersession_events(
                uow,
    ...
    @staticmethod
    def _append_automation_supersession_events(
        uow: Any,
        *,
        ...
        *,
        ...
        def guard(uow: Any, acceptance: Mapping[str, str]) -> None:
            ...
            if accepted_command_exists(for_update=True):
                return
            self._supersede_safely_suspended_runs(
                uow,
                automation_id=safe_id,
