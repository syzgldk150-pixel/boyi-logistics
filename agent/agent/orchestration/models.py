...
RUN_TRANSITIONS: dict[RunStatus, frozenset[RunStatus]] = {
    ...
    RunStatus.NEEDS_CLARIFICATION: frozenset({RunStatus.CONTEXT_READY, RunStatus.CANCELLED, RunStatus.FAILED_TERMINAL}),
    RunStatus.BLOCKED_LOGIN: frozenset({RunStatus.CONTEXT_READY, RunStatus.CANCELLED, RunStatus.FAILED_TERMINAL}),
    RunStatus.BLOCKED_DATA: frozenset({RunStatus.CONTEXT_READY, RunStatus.CANCELLED, RunStatus.FAILED_TERMINAL}),
    RunStatus.FAILED_RETRYABLE: frozenset({RunStatus.CONTEXT_READY, RunStatus.CANCELLED, RunStatus.FAILED_TERMINAL}),
