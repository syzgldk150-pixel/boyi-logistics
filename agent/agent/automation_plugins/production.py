...
from agent.automation_plugins.production_connectors import build_production_connector_registry
...
from agent.automation_plugins.production_coeffects import ProductionRuntimeCoeffectProvider, _digest
...
def build_production_automation_plugin_runtime(
    *,
    ...
    connector_registry = build_production_connector_registry(broker_handlers)
    contribution_backend_availability = RuntimeContributionBackendAvailability()
