...
class TMSRoutesTests(unittest.TestCase):
    ...
    def test_isolated_lookup_route_preserves_real_adapter_transport(self):
        ...
        requests = (
            ...
            ("yunda", "/ky_inms/public/index.php/getCurrentTime.html", "", b"", ""),
            ("yunda", "/ky_inms/public/index.php/Region/province.html", "state=fixture", b"", ""),
            ("yunda", "/ky_inms/public/index.php/Region/city.html", "state=fixture",
             b"bm=fixture-region", "application/x-www-form-urlencoded"),
            ("yunda", "/ky_inms/public/index.php/Region/county.html", "state=fixture",
             b"bm=fixture-region", "application/x-www-form-urlencoded"),
            ("yunda", "/ky_inms/public/index.php/checkBoxIsDiscount.html", "",
             b"CreatedDotCode=fixture-site&SettlementTotalNumber=0", "application/x-www-form-urlencoded"),
            ("yunda", "/ky_inms/public/index.php/checkTextIsDiscount.html", "",
             b"CreatedDotCode=fixture-site&SettlementTotalNumber=0", "application/x-www-form-urlencoded"),
