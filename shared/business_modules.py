...
BUSINESS_MODULE_CATALOG = register_business_modules(
    (
        ...
        _module("finance", "/modules/finance", "财务模块", disable_allowed=True, api_prefixes=("/finance", "/runtime/finance_knowledge"), internal_extensions=("finance.ronghui.source.enabled", "finance.yunda.source.not_launched", "finance.sync", "finance.bi"), tool_names=("query_business_finance", "sync_finance_bills")),
