...
class YundaEntryBackendTests(unittest.TestCase):
    ...
    def test_captured_initialization_posts_cross_real_console_proxy_without_waybill_writes(self):
        ...
        cases = [
            ...
            ("yunda", yunda_root + "getCurrentTime.html", "", b""),
            ("yunda", yunda_root + "Region/province.html", "state=fixture", b""),
            ("yunda", yunda_root + "Region/city.html", "state=fixture", b"bm=fixture-region"),
            ("yunda", yunda_root + "Region/county.html", "state=fixture", b"bm=fixture-region"),
            ("yunda", yunda_root + "checkBoxIsDiscount.html", "",
             b"CreatedDotCode=fixture-site&SettlementTotalNumber=0"),
            ("yunda", yunda_root + "checkTextIsDiscount.html", "",
             b"CreatedDotCode=fixture-site&SettlementTotalNumber=0"),
    ...
    def test_isolated_original_page_rejects_write_without_exact_origin(self):
        ...
        handler = _LiveHandler(
            headers={
                "Host": "www.boyi.homes",
                "Cookie": f"shipnow_original_yunda={capability}",
                "Origin": "https://boyi.homes",
            }
        )

        handled = app._handle_isolated_original_page_request(
            handler,
            urlparse("https://www.boyi.homes/original/yunda/ky_inms/public/index.php/business/waybill/entry/indexNew.html"),
            method="POST",
        )
    ...
    def test_isolated_original_page_does_not_let_referer_override_bad_origin(self):
        app = self._app(repository=_OriginalPageRepository())
        capability = "capability-token"
        app._original_page_capabilities = {
            capability: {
        ...
        handler = _LiveHandler(
            headers={
                ...
                "Referer": "https://www.boyi.homes/original/yunda/",
            }
        )
        ...
        handled = app._handle_isolated_original_page_request(
            handler,
            urlparse(
                "https://www.boyi.homes/original/yunda/"
                "ky_inms/public/index.php/business/waybill/entry/indexNew.html"
            ),
            method="POST",
        )
    ...
    def test_isolated_original_page_writes_do_not_consult_legacy_module_lifecycle(self):
        providers = {
            "yunda": (
        ...
        for provider, (path, proxy_method) in providers.items():
            with self.subTest(provider=provider):
                ...
                app._original_page_state_lock = threading.Lock()
                proxy_calls = []
                setattr(app, proxy_method, lambda *args, **kwargs: proxy_calls.append((args, kwargs)))
                handler = _LiveHandler(
                    headers={
                        "Host": "www.boyi.homes",
                        "Cookie": f"shipnow_original_{provider}={capability}",
    ...
    def test_isolated_original_page_get_shell_does_not_require_legacy_module_lifecycle(self):
