...
class NavigationPerformanceTests(unittest.TestCase):
    ...
    def test_base_template_does_not_load_chart_js_globally(self):
        ...
        self.assertIn("/static/console_ui.js?v=cal-console-20260812-tabs1", template)
        ...
        self.assertIn("/static/console_ui.js?v=cal-console-20260812-tabs1", login_template)
    ...
    def test_console_ui_keeps_home_tab_pinned_and_visible(self):
        ...
        self.assertIn("function getPinnedHomeTab()", script)
        self.assertIn('title: "概览"', script)
        self.assertIn('const homeTab = openTabs.get("/") || getPinnedHomeTab()', script)
        self.assertIn("const tabs = [homeTab, ...otherTabs]", script)
        self.assertIn('if (tabKey === "/")', script)
        self.assertIn('ensureModuleTab(new URL("/", window.location.href)', script)
        self.assertIn("const nextTab = pickNextTab(tab) || getPinnedHomeTab()", script)
